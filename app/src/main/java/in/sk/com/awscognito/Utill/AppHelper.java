package in.sk.com.awscognito.Utill;
/*
...
public class AppHelper {
     ...
     */
    private static Regions cognitoRegion = Regions.AP_SOUTH_1;
    ...
    public static void init(Context context) {
        ...
        if (userPool == null) {
            ...
            Regions cognitoRegion1=identityProviderClient.getRegions();
            Log.e("TAG","region"+cognitoRegion1.getName());
