...
import in.sk.com.awscognito.SignInActivity;
...
public class SignInView extends LinearLayout {
    ...
    public static final int DEFAULT_LOGO_IMAGE_RES_ID = R.drawable.aapp_logo;
    ...
    private void setUpSignInButtons(final Context context) {
        ...
        signInButtonHeight = getResources().getDimensionPixelSize(R.dimen.height);
